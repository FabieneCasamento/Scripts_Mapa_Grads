...
'draw title INDICE SWEAT 'hora_ti'/'dia_ti'/'mes_ti'/'ano_ti' \ > 400 Poss. de Tornados '
...
'set clevs 0 500 1000 1500 2000 2500 3000 3500 4000 4500 5000'
'set ccols 65 55   56   57   58   59   60  61   62  63    64'
*=======================================================================
...
*'draw string 5.5 1.5  CAPE 0-1000 => Leve Tempestade || 1000-2500 => Tempestade Moderada'
*'draw string 5.5 1.35  2500-4000 => Tempestade Acentuada || >4000 => Tempestade Extrema'

'draw title MAX CAPE (J/kg) 'hora_ti'/'dia_ti'/'mes_ti'/'ano_ti' \ > 4000 = TEMPESTADE ++ SEVERA'




if (count<10)
'printim /p1/operacao/scripts/wrf/NOVOVentoPortoSP/2Litoral_INS-SP00'count'horas.gif x1480 y700'
...
'printim /p1/operacao/scripts/wrf/NOVOVentoPortoSP/2Litoral_INS-SP0'count'horas.gif x1480 y700'
endif
else

'printim /p1/operacao/scripts/wrf/NOVOVentoPortoSP/2Litoral_INS-SP'count'horas.gif x1480 y700'
